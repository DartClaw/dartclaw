...
class RunnersShowCommand extends ConnectedCommand {
  RunnersShowCommand({super.config, super.apiClient, super.writeLine, super.exitFn}) {
  ...
  Future<void> run() => runConnected((apiClient) async {
    ...
    final runner = await apiClient.getObject('/api/runners/$runnerId');
