...
**Status:** Accepted (runtime-provisioning implementation: 0.16.4 / S71; namespace flipped to `dartclaw-*` 2026-04-27; native user-tier install simplified 2026-05-04)
**Date:** 2026-04-24 (original); 2026-04-27 (namespace amendment); 2026-05-04 (install-scope simplification)
