...
- [`dev/tools/arch_check.dart`](tools/arch_check.dart)
...
run `dart run dev/tools/arch_check.dart` before considering the change complete.

## Related Reading

- [Architecture](../docs/guide/architecture.md)
- [SDK Package Guide](../docs/sdk/packages.md)
- [README](../README.md)
