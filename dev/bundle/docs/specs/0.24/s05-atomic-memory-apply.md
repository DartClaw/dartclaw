...
- [ ] **S01 [OC01] [TI03,TI05,TI06] A mixed valid personal-memory change set commits once with exact per-operation outcomes**
...
- [ ] **S06 [OC03,OC04] [TI03,TI04,TI05] Forgetting removes entry content everywhere and the host copies none of it into the audit**
...
- [ ] S05 returns typed canonical/index reconciliation facts only; story S08 is the sole owner of persistent index-health state, recovery transitions, last reconciliation, and health clearing.
...
Altitude: fis-local
Affected surface: Feature Overview and Goal (OC03); Constraints & Gotchas ("Settled operation shapes"); Acceptance Scenario S06 (When and Then); Implementation Task TI04 (statement and Verify)
