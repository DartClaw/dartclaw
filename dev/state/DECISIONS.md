...
| [044](../adrs/044-workflow-orchestration-agent-architecture.md) | Workflow Orchestration Agent — In-Engine Decision-Object Seam, Dedicated Scope, Hybrid Anti-Thrash, Per-Hold Lifecycle | Proposed (targets 0.26 — shifted by the 2026-07-24 renumber: 0.23 = database backend) | Workflow / agent |
| [045](../adrs/045-pluggable-database-backend.md) | Pluggable Database Backend — SQLite Default, PostgreSQL Opt-In | Accepted 2026-07-24; schema strategy amended 2026-07-30 (current-schema bootstrap + compatibility gate replaces the planned migration runner; targets **0.23**) | Storage |
