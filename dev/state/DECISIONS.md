...
| [045](../adrs/045-pluggable-database-backend.md) | Pluggable Database Backend — SQLite Default, PostgreSQL Opt-In | Accepted 2026-07-24 (council-reviewed + remediated; all eight posture/contract decisions owner-accepted; targets **0.23** — phases 1+2 one milestone; `pgvector` deferred pending embedding-source decision) | Storage |
