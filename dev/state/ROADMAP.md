...
**Status: Implemented; scope frozen, final manual validation pending.** Opened 2026-07-25 after a post-release audit of `v0.22.0`
...
Signal, and Signal/WhatsApp typing behavior. Automated release checks and GitHub CI pass on the scope-frozen branch;
full workflow-live, complete UI smoke, and paired-device typing checks remain before merge and tag. Sequenced before
0.26, whose Phase-0 chat components this release changes by construction.
