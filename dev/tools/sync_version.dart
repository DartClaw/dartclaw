...
// Syncs packages/dartclaw_runtime/lib/src/version.dart from pubspec.yaml.
...
void main(List<String> args) {
  ...
  final pubspec = File('$root/packages/dartclaw_runtime/pubspec.yaml');
  final out = File('$root/packages/dartclaw_runtime/lib/src/version.dart');
  String? version;
