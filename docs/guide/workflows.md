...
Configure source, ref, install scope, and network behavior under `andthen:` in `dartclaw.yaml`; see [AndThen Skills](andthen-skills.md). DC-native skills are copied into the same destination trees automatically.
