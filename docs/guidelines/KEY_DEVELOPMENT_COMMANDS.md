...
> **Strategy**: See `docs/guidelines/TESTING-STRATEGY.md` for philosophy, test layers, async patterns, and coverage guidance.
>
...
See `../../../dartclaw-public/docs/testing/UI-SMOKE-TEST.md` for concrete numbered test cases (TC-01…TC-18).
