...
**Characteristics**:
- Defined in [`docs/testing/UI-SMOKE-TEST.md`](../../../dartclaw-public/docs/testing/UI-SMOKE-TEST.md) (18+ numbered test cases)
...
|---------|---------|---------|
| `plain` | `bash docs/testing/plain/run.sh` | No channels, guards on, seeded data |
| `channels` | `bash docs/testing/channels/run.sh` | WhatsApp + Signal enabled |
