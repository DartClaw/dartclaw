...
enum AcpHarnessErrorCode {
  ...
  /// The ACP peer sent a payload outside the supported protocol shape.
  protocolViolation('ACP_PROTOCOL_VIOLATION'),

  /// ACP session close failed.
  closeFailed('ACP_CLOSE_FAILED'),

  /// The requested provider capability is unsupported.
  unsupportedCapability('ACP_UNSUPPORTED_CAPABILITY');
