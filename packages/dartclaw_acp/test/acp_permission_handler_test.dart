...
Future<({Future<TurnResult> turn})> _beginTurn(AcpHarness harness, FakeAcpProcess process, String workspace) async {
...
Future<void> _finishTurn(FakeAcpProcess process, Future<TurnResult> turn) async {
