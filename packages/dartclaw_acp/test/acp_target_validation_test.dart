...
''');
      ...
      expect(acpConfigFor(relay)['goose']!.securityClassification, AcpSecurityClassification.hostOnly);
      expect(acpConfigFor(relay)['vibe']!.securityClassification, AcpSecurityClassification.hostOnly);
      expect(acpConfigFor(relay)['goose']!.containerProfile, AcpContainerProfile.restricted);
      expect(acpConfigFor(relay)['vibe']!.containerProfile, AcpContainerProfile.workspace);
    });
  });
}
