...
final class FakeAcpProcess extends CapturingFakeProcess {
  new({super.completeExitOnKill = true, super.stdoutController, super.stderrController, super.closeStreamsOnExit});
  ...
  Future<void> respondTo(String method, Object? result) async {
