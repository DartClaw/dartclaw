...
class ThreadBindingFeatureConfig {
  ...
  bool operator ==(Object other) =>
      ...
      other is ThreadBindingFeatureConfig && enabled == other.enabled && idleTimeoutMinutes == other.idleTimeoutMinutes;
  ...
  factory ThreadBindingFeatureConfig.fromYaml(Map<String, dynamic>? yaml) {
    ...
    return ThreadBindingFeatureConfig(enabled: yaml['enabled'] == true, idleTimeoutMinutes: timeoutMinutes);
  }

  /// Serializes to a JSON map.
  Map<String, dynamic> toJson() => {'enabled': enabled, 'idleTimeoutMinutes': idleTimeoutMinutes};
}
...
class FeaturesConfig {
  ...
  /// Serializes to a JSON map.
  Map<String, dynamic> toJson() => {'threadBinding': threadBinding.toJson()};
}
