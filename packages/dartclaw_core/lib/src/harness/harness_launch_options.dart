...
class HarnessLaunchOptions {
  ...
  /// - Is deleted before every start as well as on stop, dispose and the
  ///   teardown a stream fault triggers, so it cannot outlive its process
  ///
