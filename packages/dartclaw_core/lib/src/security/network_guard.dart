...
class NetworkGuardConfig {
  ...
  NetworkGuardConfig({
    ...
    required this.exfilPatterns,
    this.agentOverrides = const {},
  });

  /// Hardcoded safe defaults.
  factory NetworkGuardConfig.defaults() => NetworkGuardConfig(
    allowedDomains: {..._defaultAllowedDomains},
    exfilPatterns: _defaultExfilPatterns,
  );
  ...
  static const _defaultAllowedDomains = {
    ...
    'api.anthropic.com',
    'pypi.org', '*.pypi.org',
    'npmjs.com', '*.npmjs.com', 'registry.npmjs.org',
    'pub.dev', '*.pub.dev',
    '*.googleapis.com',
    'dart.dev', '*.dart.dev',
    'crates.io',
...
class NetworkGuard extends Guard {
  ...
  NetworkGuard({NetworkGuardConfig? config})
      : config = config ?? NetworkGuardConfig.defaults();
