...
AgentExecution agentExecutionFromRow(Map<String, Object?> row, {String prefix = ''}) => AgentExecution(
...
AgentExecution? nullableAgentExecutionFromRow(Map<String, Object?> row, {required String prefix}) {
...
WorkflowStepExecution workflowStepExecutionFromRow(Map<String, Object?> row, {String prefix = ''}) =>
...
WorkflowStepExecution? nullableWorkflowStepExecutionFromRow(Map<String, Object?> row, {required String prefix}) {
