...
class TurnTraceSummary {
  /// Sum of fresh input tokens across the aggregated traces.
  final int totalInputTokens;

  /// Sum of output tokens across the aggregated traces.
  final int totalOutputTokens;

  /// Sum of cache-read tokens across the aggregated traces.
  final int totalCacheReadTokens;

  /// Sum of cache-write tokens across the aggregated traces.
  final int totalCacheWriteTokens;

  /// Sum of wall-clock duration in milliseconds across the aggregated traces.
  final int totalDurationMs;

  /// Total tool invocations across the aggregated traces.
  final int totalToolCalls;

  /// Number of traces in the aggregate.
  ...
  /// Sum of [totalInputTokens] and [totalOutputTokens].
  int get totalTokens => totalInputTokens + totalOutputTokens;

  /// Serializes this summary to a JSON-ready map.
