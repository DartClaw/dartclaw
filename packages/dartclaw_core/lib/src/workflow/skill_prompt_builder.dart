...
class SkillPromptBuilder {
  ...
  const SkillPromptBuilder({required PromptAugmenter augmenter})
  ...
  /// contextInputs. [outputs] and [evaluator] are forwarded to
  /// [PromptAugmenter] for schema augmentation.
  String build({
    ...
    return _augmenter.augment(prompt, outputs, evaluator: evaluator);
  }
