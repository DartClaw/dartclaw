...
void main() {
  group('Google Chat session key derivation', () {
    test('DM with perContact scope (default)', () {
      ...
      // perContact uses dmPerContact which does NOT include channel type
    ...
    test('Per-channel override takes precedence over global', () {
      ...
      // Should use perContact (override), not shared (global)
...
/// Minimal MessageQueue that does nothing — only deriveSessionKey is tested.
