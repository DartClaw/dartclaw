import 'package:dartclaw_core/src/config/project_config.dart';
...
void main() {
  ...
  group('ProjectConfig', () {
    ...
    test('isEmpty false when definitions present', () {
      final config = ProjectConfig(definitions: {
        'x': const ProjectDefinition(id: 'x', remote: 'git@h:u/x'),
      });
      expect(config.isEmpty, isFalse);
    });
