...
void main() {
  group('CodexSettings', () {
    ...
    test('translateApproval maps documented YAML values to Codex values', () {
      expect(CodexSettings.translateApproval('on-request'), 'onRequest');
      expect(CodexSettings.translateApproval('unless-allow-listed'), 'unlessAllowListed');
