    ...
    group('JSON serialization', () {
      ...
      group('workflowRunId and stepIndex', () {
        test('toJson nests workflowStepExecution when hydrated', () {
          ...
          final json = task.toJson();
          expect(json['workflowStepExecution'], containsPair('workflowRunId', 'run-42'));
          expect(json['workflowStepExecution'], containsPair('stepIndex', 2));
        });
      ...
      test('toJson does not synthesize workflowStepExecution from bare flat fields', () {
        ...
        expect(
          ...
          isFalse,
          reason:
              'workflowStepExecution must be emitted only from hydrated WSE, never fabricated from legacy flat fields',
        );
      });
