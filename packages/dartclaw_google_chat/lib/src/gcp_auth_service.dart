...
/// Creates Google-authenticated HTTP clients from service-account credentials.
class GcpAuthService {
  final String _clientEmail;
  final String _privateKey;

  /// OAuth scopes requested for the authenticated client.
  final List<String> scopes;

  /// Optional base client used for HTTP transport and testing.
  ...
  /// Resolves service-account JSON from config text, a config path, or env vars.
  ...
  /// Async variant of [resolveCredentialJson] that accepts a custom file reader.
