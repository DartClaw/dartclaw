...
SecurityConfig _parseSecurity(Map<String, dynamic> yaml, SecurityConfig defaults, List<String> warns) {
  ...
  if (contentMap != null) {
    ...
    if (classifierVal != null) {
      final field = ConfigMeta.fields['guards.content.classifier']!;
      if (FieldConstraints.evaluate(field, classifierVal) == null) {
  ...
  final guardAuditMaxRetentionDays = ConfigNumericBounds.clamp(
