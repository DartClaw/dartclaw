...
class ContentGuard extends Guard {
  ...
  @override
  Duration get evaluationBudget => _scan.timeout + const Duration(seconds: 1);

  @override
  GuardVerdict onEvaluationTimeout(GuardContext context) =>
      _scan.failOpen ? GuardVerdict.pass() : GuardVerdict.block('Content classification failed (fail-closed)');
