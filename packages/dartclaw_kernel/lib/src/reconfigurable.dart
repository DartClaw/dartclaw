...
abstract interface class Reconfigurable {
  ...
  /// cares about (e.g. `'context.*'`, `'alerts.enabled'`).
  ///
  /// [ConfigNotifier] only calls [reconfigure] when the delta contains at
  /// least one key that intersects with this set, and refuses registration
  /// outright when a key resolves to a restart-tier section.
