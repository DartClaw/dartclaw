...
///
/// Persisted as the owner of every steward-written fact, so changing it
/// orphans facts written by earlier runs. It matches `mcpStewardPrincipal` by
/// value; do not make either an alias of the other, since only this one is
/// durable.
