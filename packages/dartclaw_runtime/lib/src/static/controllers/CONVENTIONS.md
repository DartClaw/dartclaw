...
- Follow [ADR-036's controller-ownership amendment](../../../../../../../dev/adrs/036-web-ui-interaction-layer-stimulus-on-htmx.md#amendment-2026-08-24--bound-controller-ownership-to-client-behaviour): HTMX owns mutations and server-state rendering; controllers own browser-local behaviour.
