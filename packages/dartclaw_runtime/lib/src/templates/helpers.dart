...
/// Renders [bytes] as an operator-facing size with one decimal above the byte
/// tier, for CLI output and runtime log lines.
///
/// [formatBytes] above is a different formatter — it rounds KB to whole numbers
/// and has no GB tier — so page text and operator text are deliberately not the
/// same rendering.
