...
Map<String, dynamic> _buildContext(Map<String, dynamic> status, String sidebar, String topbar, String workspacePath) {
  ...
  final errorsCount = hasCollectionProjection
      ? (collectionAvailable ? collection['errorEntryCount'] as int? : null)
      : errorsMd['coverage'] == 'lowerBound'
      ? null
      : errorsMd['entryCount'] as int?;
  ...
  return {
    ...
    'errorRoleCount': _known(collection['errorEntryCount']),
