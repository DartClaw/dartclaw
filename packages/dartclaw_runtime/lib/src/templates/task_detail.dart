...
String taskDetailPageTemplate({
  ...
  final actionQuerySuffix = actionQuery.isEmpty ? '' : '?$actionQuery';
  ...
  final body = templateLoader.trellis.render(templateLoader.source('task_detail'), {
    ...
    'startAction': '/tasks/${task['id']}/start$actionQuerySuffix',
    'cancelAction': '/tasks/${task['id']}/cancel$actionQuerySuffix',
    'reviewAction': '/tasks/${task['id']}/review$actionQuerySuffix',
...
/// The page head's description line: the goal when present, otherwise status.
