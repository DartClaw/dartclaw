...
class TurnContext {
  ...
  /// Optional wall-clock override for this provider turn.
  ...
  /// Optional provider-enforced output schema for this turn.
  final Map<String, dynamic>? outputSchema;

  /// Optional provider-native session identity to resume.
  final String? providerSessionId;

  /// Whether the provider should mint a durably resumable session.
  final bool requestProviderSessionResume;
  ...
  new({
    ...
    this.requestProviderSessionResume = false,
...
class TurnManager implements core.TurnManager {
