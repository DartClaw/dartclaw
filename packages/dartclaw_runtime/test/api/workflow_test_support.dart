// Shared configurable fake for [WorkflowService] used across workflow routes,
// SSE, run-form, webhook and MCP tests.
//
// WorkflowService is dartclaw_runtime-owned (its repository/messages/kv deps are
