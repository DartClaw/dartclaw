...
import 'package:dartclaw_runtime/src/asset_resolver.dart';
...
void main() {
  ...
  setUp(() {
    ...
    final templates = Directory(p.join(root, 'packages', 'dartclaw_runtime', 'lib', 'src', 'templates'))
      ..createSync(recursive: true);
    final staticAssets = Directory(p.join(root, 'packages', 'dartclaw_runtime', 'lib', 'src', 'static'))
      ..createSync(recursive: true);
