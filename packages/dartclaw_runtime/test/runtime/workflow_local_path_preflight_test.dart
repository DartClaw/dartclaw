...
import 'package:dartclaw_runtime/src/runtime/workflow_local_path_preflight.dart';
import 'package:dartclaw_runtime/dartclaw_runtime.dart' show WorkflowStartPreconditionException;
...
void main() {
  ...
  test(
    'S54: configured branch check compares observed branch against configuredBranch, not caller BRANCH override',
    () async {
