...
import 'package:dartclaw_runtime/src/templates/task_event_display.dart';
...
void main() {
  ...
  late String iconsCss;

  setUpAll(() async {
    final staticDir = await resolveStaticDir();
    controllerSource = File('$staticDir/controllers/dc_tasks_controller.js').readAsStringSync();
    iconsCss = File('$staticDir/icons.css').readAsStringSync();
  });
