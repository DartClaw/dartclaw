...
import 'package:dartclaw_runtime/src/templates/task_status_display.dart';
...
void main() {
  ...
  test('every emitted pill and dot suffix resolves to a rule in canon', () async {
  ...
  test('presentation is chosen in one place, with no wildcard bypass', () async {
    final source = File(await resolveServerPackagePath('lib', 'src', 'templates', 'task_status_display.dart'))
        .readAsStringSync();
