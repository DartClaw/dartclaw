...
String addProjectDialogHtml() {
  return '''
<dialog id="add-project-dialog" class="dialog dialog--md card card-glass">
  <form id="add-project-form" method="dialog">
    <div class="dialog-header">
      <h2 class="t-heading">Add Project</h2>
    ...
    <div class="dialog-footer">
      <div id="add-project-error" class="form-error t-caption"></div>
