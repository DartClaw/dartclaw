...
void main() {
  final controller =
      File('packages/dartclaw_server/lib/src/static/controllers/dc_attribution_controller.js').existsSync()
      ? File('packages/dartclaw_server/lib/src/static/controllers/dc_attribution_controller.js')
      : File('lib/src/static/controllers/dc_attribution_controller.js');
