...
void main() {
  ...
  setUp(() {
    ...
    taskDetail = taskDetailPageTemplate(
      sidebarData: sidebar,
      navItems: navItems,
      task: {'id': 't1', 'title': 'A task', 'type': 'coding', 'status': 'draft'},
      artifacts: const [],
    );
  ...
  test('the page templates carry no direct pagehead markup of their own', () {
    final dir = Directory('packages/dartclaw_server/lib/src/templates').existsSync()
