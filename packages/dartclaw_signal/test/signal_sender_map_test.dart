...
void main() {
  ...
  group('SignalSenderMap', () {
    test('resolve with both phone and UUID stores mapping and returns phone', () {
      ...
      final result = map.resolve(sourceNumber: '+1234567890', sourceUuid: '12bfcd5a-3363-45f4-94b6-3fe247f11ab8');
    ...
    test('resolve with UUID only returns cached phone when mapping exists', () {
      final map = SignalSenderMap(filePath: filePath);
      // First: store mapping
      map.resolve(sourceNumber: '+1234567890', sourceUuid: '12bfcd5a-3363-45f4-94b6-3fe247f11ab8');
      // Second: UUID only
      final result = map.resolve(sourceUuid: '12bfcd5a-3363-45f4-94b6-3fe247f11ab8');
      expect(result, '+1234567890');
    });
    ...
    test('phone change updates mapping (same UUID, new phone)', () {
      final map = SignalSenderMap(filePath: filePath);
      map.resolve(sourceNumber: '+1234567890', sourceUuid: '12bfcd5a-3363-45f4-94b6-3fe247f11ab8');
      map.resolve(sourceNumber: '+9876543210', sourceUuid: '12bfcd5a-3363-45f4-94b6-3fe247f11ab8');
      expect(map.length, 1);
    ...
    test('invalid E.164 phone not stored', () {
      final map = SignalSenderMap(filePath: filePath);
      final result = map.resolve(sourceNumber: 'not-a-phone', sourceUuid: '12bfcd5a-3363-45f4-94b6-3fe247f11ab8');
    ...
    test('invalid UUID not stored', () {
      final map = SignalSenderMap(filePath: filePath);
      final result = map.resolve(sourceNumber: '+1234567890', sourceUuid: 'not-a-uuid');
    ...
    test('load from valid JSON file', () async {
      ...
      expect(map.resolve(sourceUuid: 'aaaabbbb-cccc-dddd-eeee-ffffffffffff'), '+44771234567');
    });
    ...
    test('length reflects stored mappings', () {
      ...
      map.resolve(sourceNumber: '+1234567890', sourceUuid: '12bfcd5a-3363-45f4-94b6-3fe247f11ab8');
      expect(map.length, 1);
      map.resolve(sourceNumber: '+44771234567', sourceUuid: 'aaaabbbb-cccc-dddd-eeee-ffffffffffff');
      expect(map.length, 2);
    });
