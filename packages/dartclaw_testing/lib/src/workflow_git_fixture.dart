...
class WorkflowGitFixture {
  ...
  void writeUncommittedIntegrationFiles(Map<String, String> files) =>
  ...
  Future<ProcessResult> rawGit(List<String> args, {String? inDir}) =>
      _run('git', args, cwd: inDir ?? projectDir);
