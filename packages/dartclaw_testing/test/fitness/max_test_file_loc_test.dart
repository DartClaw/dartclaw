...
//
// What this enforces:
//   1. Every `*_test.dart` file under packages/ and apps/ that is NOT
//      allowlisted must have <= 1300 lines.
...
void main() {
  ...
  test('allowlist entries ratchet: file exists, stays over the ceiling, and does not grow past its recorded LOC', () {
    ...
    if (violations.isNotEmpty) {
      fail(
        'Test file LOC ratchet violations (see packages/dartclaw_testing/test/fitness/README.md):\n'
        '  ${violations.join('\n  ')}',
      );
    }
  });
