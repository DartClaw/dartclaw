import '../workflow/workflow_definition.dart' show OutputConfig;
...
enum SkillSource {
  ...
  /// Human-readable label for the skill source.
...
class SkillInfo {
  ...
  /// Serializes this skill metadata to a JSON-ready map.
  ...
  /// Reconstructs a [SkillInfo] from its JSON representation.
