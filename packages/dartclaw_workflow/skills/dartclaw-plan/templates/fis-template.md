...
> **Size discipline**: Most strong FIS files stay in the 150-450 line range. If a draft is pushing past roughly ~600 lines or >18 implementation tasks, split it at spec time rather than expecting `dartclaw-exec-spec` to recover later.
