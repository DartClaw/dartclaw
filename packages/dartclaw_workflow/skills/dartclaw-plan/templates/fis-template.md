---
source: plugin/skills/spec/templates/fis-template.md
---
...
> **Size discipline**: Most strong FIS files stay in the 100-300 line range. If a draft is pushing past roughly ~400 lines or >12 implementation tasks, split it at spec time rather than expecting `dartclaw-exec-spec` to recover later.
