...
Choose 5-7 reviewers from `../references/reviewer-roster.md` based on scope analysis.
...
2. Use the `dartclaw-review-code` skill for the review
...
Note: The `dartclaw-review-code` skill may not be available in all environments. If unavailable, perform the review directly using your own analysis capabilities.
...
Use `../references/adversarial-challenge.md` (`Devil's Advocate`) with:
...
Use `../references/adversarial-challenge.md` (`Synthesis Challenger`) with:
