...
- **Report suffix**: short kebab-case suffix such as `review`, `code-review`, `doc-review`, `gap-review`, or `council-review`
...
- **Typed artifact**: Follow `../references/github-artifact-roundtrip.md`. Use the report suffix as the default `artifact_type` (for example `review`, `gap-review`, or `code-review`) unless the calling skill requires a narrower type.
