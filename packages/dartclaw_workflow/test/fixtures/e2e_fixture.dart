...
final class E2EFixture {
  ...
  Future<E2EFixtureInstance> build() async {
    ...
    final config = DartclawConfig(
      ...
      providers: ProvidersConfig(
        entries: {provider: ProviderEntry(executable: provider, poolSize: poolSize, options: _providerOptions())},
      ),
  ...
  Map<String, dynamic> _providerOptions() {
    if (provider == 'claude') {
      return {'permissionMode': sandbox};
    }
    return {'approval': 'never', 'sandbox': sandbox};
  }
